...
public class ColorPreference extends Preference implements ColorPickerDialogListener {
  ...
  @Override protected void onClick() {
    ...
    if (onShowDialogListener != null) {
      ...
      dialog.show(((AppCompatActivity) getContext()).getSupportFragmentManager(), getFragmentTag());
    }
  }
	...
	public void onAttached() {
		...
		if (showDialog) {
			...
			ColorPickerDialog fragment =
					(ColorPickerDialog) ((AppCompatActivity) getContext()).getSupportFragmentManager().findFragmentByTag(getFragmentTag());
			if (fragment != null) {
