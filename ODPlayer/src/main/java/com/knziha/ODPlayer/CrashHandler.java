...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public static CrashHandler getInstance(VICMainAppOptions opt) {
		if(instance == null)
	...
	private CrashHandler(VICMainAppOptions opt){
		...
		try {
			...
			if (program_info != null) {
				info_builder.append("][app_n.").append(program_info.versionName)
						.append(", app_v.").append(program_info.versionCode).append("]\n")
				;
	...
	public void uncaughtException(@NonNull Thread thread, @NonNull Throwable exception) {
		...
		if(debug) CMN.Log("crash catched", info_builder.toString());
