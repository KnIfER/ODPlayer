...
public class SplitView extends LinearLayout implements OnTouchListener {
    ...
    public float getHandleLeft() {
        int fixedVal = getOrientation()==LinearLayout.VERTICAL?mHandle.getLeft():mHandle.getTop();
        return fixedVal+ReservationLeft;
    }

    public float getHandleRight() {
        int fixedVal = getOrientation()==LinearLayout.VERTICAL?mHandle.getRight():mHandle.getBottom();
