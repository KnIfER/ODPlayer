            ...
            for (Object o1 : o) {
                ...
                if (o1 != null) {
                    ...
                    if (classname.equals("[I")) {
                        ...
                        continue;
                    } else if (o1 instanceof MediaPlayer.TrackDescription) {
                        msg.append(((MediaPlayer.TrackDescription) o1).name).append("=").append(((MediaPlayer.TrackDescription) o1).id).append("  ");
//                    MediaPlayer.TrackDescription[] arr = (MediaPlayer.TrackDescription[]) o[i];
//                    for(MediaPlayer.TrackDescription tdI:arr){
//                        msg += tdI.name;
//                        msg += ", ";
//                    }
                    }
		...
		if(UniversalObject instanceof TestTarget)
